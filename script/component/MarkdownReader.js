            ...
            return fetch(file)
                ...
                .then((body) => {
                    ...
                    showdown.extension('header-anchors', () => {
                        ...
                        var ancTpl = '$1<a id="user-content-$3" class="anchor" href="#' + this.$route.params.language + '/' + this.$route.params.document + '/$3" aria-hidden="true">#</a> $4';
                    ...
                    showdown.extension('links-replacer', () => {
                        return [{
                            type: "html",
                            regex: /<a href="#(.*)">/g,
                            replace: "<a href='#/" + this.language + "/" + this.document + "/$1'>"
                        }];
                    });
                    ...
                    showdown.extension('other-page-links-replacer', () => {
                        return [{
                            ...
                            replace: "<a href='#/" + this.language + "/$2/$3'>"
                        }];
                    });
